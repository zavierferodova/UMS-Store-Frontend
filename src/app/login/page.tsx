        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-dvh">
            <div className="col-span-1 relative flex flex-col justify-center items-center p-5">
                ...
                <div className="mb-8 text-center">
                    ...
                    <div className="text-sm text-muted-foreground font-medium">Masukan Identitas Anda untuk Memulai</div>
                </div>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 w-full max-w-sm">
                                    ...
                                    <FormControl>
                                        <div className="relative">
                                            <div className="flex items-center absolute left-3 top-1/2 -translate-y-1/2 gap-2">
                                                ...
                                                <Separator orientation="vertical" className="data-[orientation=vertical]:h-6 data-[orientation=vertical]:w-[2px] bg-gray-500/30" />
                                            </div>
                                ...
                                <FormItem>
                                    <FormControl>
                                        <div className="relative">
                                            ...
                                            <Input type="password" placeholder="Password" {...field} className="pl-13 py-6 rounded-lg" />
                                        </div>
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                        ...
                        />
                        <Button type="submit" className="w-full p-6 rounded-xl">
                            Masuk
                        </Button>
                    </form>
                </Form>
                ...
                <div className="mt-8 text-center w-[80%] lg:w-[60%] absolute bottom-15">
                    <p className="text-sm text-muted-foreground">Masuk dan mulai kelola transaksi, produk, pesanan, dan diskon dengan mudah dalam satu website terintegrasi.</p>
                </div>
            </div>
